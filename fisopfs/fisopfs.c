...
/**
 * Probamos distintos comandos en función de las operaciones requeridas para el
 * TP, para ver qué operaciones de FUSE eran llamadas.
 * 		- // + --> son las que fueron llamadas
 * 		- // ? --> no fueron llamadas pero pensamos que podemos llegar a
 * necesitar implementarlas, o nos parece raro que no hayan sido llamadas
 * 		- // * --> challenges (opcionales)
 *      - // - --> En principio no las tenemos que implementar en absoluto
 */
